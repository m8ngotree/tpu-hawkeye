...
a real LLM API call. Taxonomy: `01_mxu_feed`, `02_vmem_tile_layout`, and
`03_vectorized_vmem` written and correctness-verified (CPU/interpret mode only, not
yet on real TPU hardware); 5 cells remain. Next real chunk of work: the rest of the
taxonomy, then smoke-test
